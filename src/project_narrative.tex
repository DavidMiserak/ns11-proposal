...
It is important to note that this mission will build off of the previous work of VTC's successful 2012 Vermont Lunar project, using the original software, and communications tools developed, providing a sustantial boost to the missions current state. 
